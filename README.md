...
- ✅ 회원가입 (사용자명, 이메일, 비밀번호)
- ✅ 로그인/로그아웃
- ✅ 프로필 수정 (사용자명, 이메일, 이름, 성)
- ✅ 비밀번호 변경 (현재 비밀번호 확인)
- ✅ Django 기본 인증 시스템 사용
- ✅ 로그인 필수 페이지 접근 제어 (@login_required)
...
### 프로필 관리
1. 로그인 후 홈페이지에서 "내 정보 수정" 버튼 클릭
2. 사용자명, 이메일, 이름, 성 수정 가능
3. "저장하기" 버튼으로 변경사항 저장
4. "비밀번호 변경" 버튼으로 비밀번호 변경 페이지 이동
5. 현재 비밀번호 입력 후 새 비밀번호 설정
